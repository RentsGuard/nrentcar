...
<div class="hero-section">
    <nav class="flex items-center justify-between px-6 sm:px-10 py-4 relative z-10">
        ...
        <div class="flex items-center gap-3">
            <a href="#mobil" class="hidden sm:inline text-sm text-white/70 hover:text-white px-3 py-2 rounded-lg hover:bg-white/[0.05] transition-colors no-underline">Mobil</a>
            ...
            <a href="#mobil" class="text-sm font-semibold text-white px-4 py-2 rounded-lg bg-[#C1121F] shadow-[0_4px_15px_rgba(193,18,31,0.3)] hover:bg-[#a30f1a] transition-colors no-underline">Lihat Mobil</a>
        </div>
    </nav>
    ...
    <div class="flex-1 flex flex-col items-center justify-center text-center px-6 sm:px-10 relative z-10">
        ...
        <div class="flex flex-wrap gap-4 justify-center">
            <a href="#mobil" class="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-[#C1121F] text-white font-semibold text-base shadow-[0_8px_25px_rgba(193,18,31,0.3)] hover:bg-[#a30f1a] hover:-translate-y-0.5 transition-all no-underline">
...
<div class="py-16 sm:py-20 px-6 sm:px-10 relative z-10" id="mobil">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        <div class="rounded-2xl border border-white/[0.06] bg-[#141414]/60 backdrop-blur-xl overflow-hidden hover:border-[#C1121F]/30 hover:-translate-y-1 transition-all duration-300 shadow-[0_12px_40px_rgba(0,0,0,0.3)]">
            <div class="h-44 bg-white/[0.02] flex items-center justify-center text-5xl text-white/[0.12] border-b border-white/[0.06]"><i class="bi bi-car-front"></i></div>
            <div class="p-5">
                <h3 class="text-lg font-bold text-white mb-1">{{ $mobil->nama_mobil }}</h3>
