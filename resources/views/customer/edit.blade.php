...
function wilayahForm() {
    return {
        ...
        kecamatanList: [],
        kelurahanList: [],
        selectedProvinsi: '{{ old("provinsi", $customer->provinsi) }}',
        selectedKabupaten: '{{ old("kota_kabupaten", $customer->kota_kabupaten) }}',
        selectedKecamatan: '{{ old("kecamatan", $customer->kecamatan) }}',
        selectedKelurahan: '{{ old("kelurahan", $customer->kelurahan) }}',
