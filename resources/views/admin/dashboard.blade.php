...
@section('title', 'Dashboard Admin - RentSCar')
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 16px;">
        <div>
            ...
            <p style="color: rgba(255,255,255,0.5); font-size: 14px; margin: 4px 0 0 0;">
                Selamat datang kembali, {{ auth()->user()->nama_user }}. Berikut ringkasan hari ini.
            </p>
        </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 16px;">
        <div class="glass-card stat-card">
            <div class="stat-card-header">
                ...
                <span class="badge-custom success" style="font-size: 11px; padding: 2px 8px;">
        ...
        <div class="glass-card stat-card">
            <div class="stat-card-header">
                ...
                <span class="badge-custom success" style="font-size: 11px; padding: 2px 8px;">
                    <i class="bi bi-arrow-up-short"></i> 22%
                </span>
            </div>
            <div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
        <div class="glass-card">
            ...
            <div style="padding: 8px 16px;">
                ...
                <div style="display: flex; align-items: center; gap: 12px; padding: 12px; border-radius: 8px; transition: all 0.2s; border: 1px solid transparent;">
            ...
            <div style="overflow-x: auto;">
                <table class="table-custom">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="4" style="text-align: center; padding: 32px; color: rgba(255,255,255,0.5);">Belum ada penyewaan aktif.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    cornerRadius: 8,
                    callbacks: {
                        label: function(ctx) { return 'Rp ' + ctx.parsed.y + 'Jt'; }
                    }
                }
            },
            scales: {
                ...
                y: {
                    ...
                    ticks: { color: 'rgba(255,255,255,0.4)', font: { size: 12 }, callback: function(v) { return 'Rp' + v + 'M'; } }
                }
            }
        }
    });
