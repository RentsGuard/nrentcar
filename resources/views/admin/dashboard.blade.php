...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-white/50 text-sm mt-1">Selamat datang kembali, {{ auth()->user()->nama_user }}. Berikut ringkasan hari ini.</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7 gap-4">
        ...
        <div class="glass-card p-6 flex flex-col justify-between h-full">
            ...
            <div>
                ...
                <h3 class="text-sm xl:text-xs 2xl:text-sm font-bold text-white break-words">Rp {{ number_format($totalPendapatan, 0, ',', '.') }}</h3>
            </div>
        </div>
        ...
        <div class="glass-card p-6 flex flex-col justify-between h-full">
            ...
            <div>
                ...
                <h3 class="text-sm xl:text-xs 2xl:text-sm font-bold text-amber-400 break-words">Rp {{ number_format($totalDenda, 0, ',', '.') }}</h3>
