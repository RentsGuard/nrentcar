...
@section('title', 'Verifikasi Baru - RentSCar')

@section('page-title', 'Verifikasi Baru')
...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white tracking-tight">Verifikasi Baru</h1>
            <p class="text-white/50 text-sm mt-1">Verifikasi data dan dokumen customer.</p>
        </div>
    </div>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" name="tanggal_verifikasi" value="{{ old('tanggal_verifikasi', date('Y-m-d')) }}" required class="w-full h-10 rounded-lg border border-white/[0.1] bg-[#0D0D0D] text-white px-3 text-sm outline-none transition-colors focus:border-[#C1121F]/50 focus:shadow-[0_0_0_2px_rgba(193,18,31,0.3)]">
                    </div>
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <textarea name="catatan_verifikasi" rows="3" placeholder="Catatan hasil verifikasi..." class="w-full rounded-lg border border-white/[0.1] bg-[#0D0D0D] text-white px-3 py-2 text-sm outline-none transition-colors placeholder:text-white/40 focus:border-[#C1121F]/50 focus:shadow-[0_0_0_2px_rgba(193,18,31,0.3)]">{{ old('catatan_verifikasi') }}</textarea>
                    </div>
                </div>
